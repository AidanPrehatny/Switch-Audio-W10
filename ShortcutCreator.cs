...
namespace SwitchAudio {
    ...
    class ToastActions {
        static public void showImageToast(string appId, string title, string message, string image)
        {
    ...
    class ToastEvents
        ...
        static class ShortCutCreator
        {
            ...
            static void InstallShortcut(string appId, string shortcutPath)
            {
                ...
                using (MS.WindowsAPICodePack.Internal.PropVariant applicationId = new MS.WindowsAPICodePack.Internal.PropVariant(appId))
                {
